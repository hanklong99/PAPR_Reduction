...
%% SLM Parameters
    ...
    bers_SLM_1 = zeros(1,length(EbN0_dB));
    ber_count=0;
...
% FBMC modulation
            for nframe_oqam=1:OQAM_Frame
                ...
                x_SLM_1=ifft(OQAM(:,nframe_oqam));

                % Duplication of the signal
                x4=[x_SLM_1.' x_SLM_1.' x_SLM_1.' x_SLM_1.'];
