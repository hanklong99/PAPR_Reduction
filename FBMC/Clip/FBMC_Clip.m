...
%% Clip
    ...
    Power_clip = zeros(K*N+(Frame*2-1)*N/2+N/2,N_iter);
...
%% Rayleight Fading Multipath: Filter
        ...
        Tx_ray=conv(ht,clipped)+Complex_noise;
...
%% errors locations
    ...
    ber = ber_count/symbol_total/N_iter;
    bers_clip(k_EbN0) = ber;
end
...
semilogy(0:EbN0_dB(end),bers_clip, 'r-');
...
semilogy(x_clip,ccdf_clip,'*-g','MarkerIndices',marker_idx);grid on; hold on;
