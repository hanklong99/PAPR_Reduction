...
legend('AWGN Analytic', 'Rayleigh Analytic', 'AWGN Simulation', 'Clipping Simulation', 'SLM Simulation','TSLM Simulation','Companding Simulation');
...
legend('CCDF of Original', 'CCDF of Clipping','CCDF of SLM','CCDF of Companding');%'CCDF of TSLM', 
