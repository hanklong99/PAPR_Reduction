...
%TSLM
N_TSLM = 1; % number of sets of SLM Phase
bers_TSLM_1=zeros(size(EbN0_dB));
...
semilogy(0:EbN0_dB(end),bers_TSLM_1, 'p-');% SLM Simulation
...
[f_TSLM,x_TSLM_1]=ecdf(papr_db_TSLM);
ccdf_TSLM_1=1-f_TSLM;

marker_idx = 1:1e3:length(x_TSLM_1);
semilogy(x_TSLM_1,ccdf_TSLM_1,'*-r','MarkerIndices',marker_idx);
