...
%TSLM
N_TSLM = 30; % number of sets of SLM Phase
bers_TSLM_30=zeros(size(EbN0_dB));
...
semilogy(0:EbN0_dB(end),bers_TSLM_30, 'p-');% SLM Simulation
...
[f_TSLM,x_TSLM_30]=ecdf(papr_db_TSLM);
ccdf_TSLM_30=1-f_TSLM;

marker_idx = 1:1e3:length(x_TSLM_30);
semilogy(x_TSLM_30,ccdf_TSLM_30,'*-r','MarkerIndices',marker_idx);
