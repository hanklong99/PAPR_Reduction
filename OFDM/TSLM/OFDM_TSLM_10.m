...
bers_TSLM_10=zeros(size(EbN0_dB));
...
semilogy(0:EbN0_dB(end),bers_TSLM_10, 'p-');% SLM Simulation
...
[f_TSLM,x_TSLM_10]=ecdf(papr_db_TSLM);
ccdf_TSLM_10=1-f_TSLM;

marker_idx = 1:1e3:length(x_TSLM_10);
semilogy(x_TSLM_10,ccdf_TSLM_10,'*-r','MarkerIndices',marker_idx);
