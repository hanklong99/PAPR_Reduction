...
%TSLM
N_TSLM = 20; % number of sets of SLM Phase
bers_TSLM_20=zeros(size(EbN0_dB));
...
semilogy(0:EbN0_dB(end),bers_TSLM_20, 'p-');% SLM Simulation
...
[f_TSLM,x_TSLM_20]=ecdf(papr_db_TSLM);
ccdf_TSLM_20=1-f_TSLM;

marker_idx = 1:1e3:length(x_TSLM_20);
semilogy(x_TSLM_20,ccdf_TSLM_20,'*-r','MarkerIndices',marker_idx);
