...
semilogy(0:EbN0_dB(end),bers_SLM_5, 'p-');% SLM Simulation
...
[f_SLM,x_SLM_5]=ecdf(papr_db_SLM);
ccdf_SLM_5=1-f_SLM;

marker_idx = 1:1e3:length(x_SLM_5);
semilogy(x_SLM_5,ccdf_SLM_5,'*-r','MarkerIndices',marker_idx);
