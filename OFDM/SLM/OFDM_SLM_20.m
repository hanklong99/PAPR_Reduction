...
semilogy(0:EbN0_dB(end),bers_SLM_20, 'p-');% SLM Simulation
...
[f_SLM,x_SLM_20]=ecdf(papr_db_SLM);
ccdf_SLM_20=1-f_SLM;

marker_idx = 1:1e3:length(x_SLM_20);
semilogy(x_SLM_20,ccdf_SLM_20,'*-r','MarkerIndices',marker_idx);
