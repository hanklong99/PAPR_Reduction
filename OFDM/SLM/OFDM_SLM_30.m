...
semilogy(0:EbN0_dB(end),bers_SLM_30, 'p-');% SLM Simulation
...
[f_SLM,x_SLM_30]=ecdf(papr_db_SLM);
ccdf_SLM_30=1-f_SLM;

marker_idx = 1:1e3:length(x_SLM_30);
semilogy(x_SLM_30,ccdf_SLM_30,'*-r','MarkerIndices',marker_idx);
