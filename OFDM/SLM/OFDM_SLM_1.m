...
%SLM
N_SLM = 1; % number of sets of SLM Phase
QPSK_SLM=zeros(symbol_total,N_SLM);
bers_SLM_1=zeros(size(EbN0_dB));
...
% Calculate BER SLM
    ...
    ber_SLM_1=ber_count/symbol_total/N_iter/2;
    bers_SLM_1(k_EbN0)= ber_SLM_1;
...
semilogy(0:EbN0_dB(end),bers_SLM_1, 'p-');% SLM Simulation
...
[f_SLM,x_SLM_1]=ecdf(papr_db_SLM);
ccdf_SLM_1=1-f_SLM;

marker_idx = 1:1e3:length(x_SLM_1);
semilogy(x_SLM_1,ccdf_SLM_1,'*-r','MarkerIndices',marker_idx);
