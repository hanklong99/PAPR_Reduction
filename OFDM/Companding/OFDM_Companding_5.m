...
%Comapnding
bers_Compd_5=zeros(size(EbN0_dB));
...
semilogy(0:EbN0_dB(end),bers_Compd_5, 'p-');% SLM Simulation
...
[f_Compd_5,x_Compd_5]=ecdf(papr_db_Compd);
ccdf_Compd_5=1-f_Compd_5;

marker_idx = 1:1e3:length(x_Compd_5);
semilogy(x_Compd_5,ccdf_Compd_5,'*-r','MarkerIndices',marker_idx);
